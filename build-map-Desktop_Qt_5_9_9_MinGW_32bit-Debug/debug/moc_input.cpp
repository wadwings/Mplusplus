...
QT_MOC_LITERAL(3, 16, 9), // "losefocus"
QT_MOC_LITERAL(4, 26, 13), // "slot_getfocus"
QT_MOC_LITERAL(5, 40, 14) // "slot_losefocus"

    },
    "input\0getfocus\0\0losefocus\0slot_getfocus\0"
    "slot_losefocus"
};
...
void input::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->losefocus(); break;
        case 2: _t->slot_getfocus(); break;
        case 3: _t->slot_losefocus(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (input::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&input::getfocus)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (input::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&input::losefocus)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject input::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_input.data,
